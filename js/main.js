...
const scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_0___default())('a[href*="#form"]', {
  speed: 200,
  offset: 100
});
...
const enableScroll = () => {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].htmlEl.style.scrollBehavior = 'auto';
  window.scroll({
    top: pagePosition,
    left: 0
  });
